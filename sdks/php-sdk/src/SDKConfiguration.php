...
use Nuovar\HookHQ\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.0.3 2.720.1 1.0 nuovar/hookhq';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(HookHQ::SERVERS[$this->serverIndex])) {
            return HookHQ::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(HookHQ::SERVERS[$this->serverIndex], []);
