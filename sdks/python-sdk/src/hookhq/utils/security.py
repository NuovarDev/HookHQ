...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("HOOKHQ_BEARER_AUTH"):
        security_dict["bearer_auth"] = os.getenv("HOOKHQ_BEARER_AUTH")

    if os.getenv("HOOKHQ_API_KEY_COOKIE"):
        security_dict["api_key_cookie"] = os.getenv("HOOKHQ_API_KEY_COOKIE")
