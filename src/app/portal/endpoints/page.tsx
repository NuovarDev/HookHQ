...
import { Plus, Search, Webhook, MoreVertical, Pencil, Trash2, BarChart3 } from "lucide-react"
                          ...
                          <Link href={`/portal/endpoints/${endpoint.id}`} className="block group">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                <p className="font-medium group-hover:text-primary transition-colors">{endpoint.name}</p>
