                                        ...
                                        <CardDescription>
                                            <div className="flex items-center gap-4 text-sm">
                                                ...
                                                {message.processingStartedAt && (
                                                    <span>
                                                        Processing: {formatDuration(message.createdAt, message.processingStartedAt)}
                                                    </span>
                                                )}
                                                {message.deliveredAt && (
                                                    <span>
                                                        Delivered: {formatDuration(message.createdAt, message.deliveredAt)}
                                                    </span>
                                                )}
                                            ...
                                            <div className="text-sm text-red-600 bg-red-50 p-2 rounded">
                                                ...
                                                {message.lastErrorAt && (
                                                    <div className="text-xs text-red-500 mt-1">
                                                        {formatTimestamp(message.lastErrorAt)}
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                    ...
                                    {message.responseStatus && (
                                        <div>
                                            ...
                                            <div className="text-sm">
                                                Status: <Badge variant={message.responseStatus < 400 ? "default" : "destructive"}>
                                                    {message.responseStatus}
                                                </Badge>
