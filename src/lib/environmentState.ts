 ...
 * Handles both database storage and cookie caching
 */

const ENVIRONMENT_COOKIE_NAME = "current-environment";
...
/**
 * Get current environment with fallback priority:
 * 1. Cookie (fastest)
 * 2. Database (user's last environment)
